...
{ 
  ...
  #cancel_bet_resp    <- httr::DELETE(paste("https://api.matchbook.com/edge/rest/offers",sep=""),body=body_data,httr::set_cookies('session-token'=session_data$session_token),httr::content_type_json(),httr::accept_json(),httr::add_headers('User-Agent'='rlibnf'))
  cancel_bet_resp    <- httr::DELETE(paste("https://api.matchbook.com/edge/rest/offers/",bet_id,sep=""),httr::set_cookies('session-token'=session_data$session_token),httr::content_type_json(),httr::accept_json(),httr::add_headers('User-Agent'='rlibnf'))  
